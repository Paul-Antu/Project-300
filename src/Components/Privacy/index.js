const Privacy = () => {
  return (
    <div className="leading-8">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Coder Planet.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Coder Planet, accessible from{" "}
            <a
              href="https://www.coderplanet.com"
              rel="noreferrer"
              target="_blank"
            >
              https://www.coderplanet.com
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By mail: info@coderplanet.com</li>
      </ul>
    </div>
  );
};
